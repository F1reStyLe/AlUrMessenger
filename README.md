...
шаги **7.1–7.2** добавляют [Project blacklist, единый content write gate и encrypted reports workflow](docs/MODERATION.md).
Следующий шаг — ban/unban 7.3. Остальная Phase 7–10, gRPC и frontend ещё не реализованы.
