...
шаги **7.1–7.3** добавляют [blacklist, reports и Project/conversation bans](docs/MODERATION.md).
Следующий шаг — полный moderation audit 7.4. Остальная Phase 7–10, gRPC и frontend ещё не реализованы.
