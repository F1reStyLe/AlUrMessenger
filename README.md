...
Добавлены **шаги 5.1–5.3**: reply references, edit с проверкой версии, soft delete,
реакции, moderator pins, независимый TEXT forward и безопасный replay текущего состояния.
Шаг 5.4, Phase 6–10, gRPC и frontend ещё не реализованы. [Identity API и seed](docs/IDENTITY.md).
